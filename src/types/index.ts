...
export type LoanType = "cash_advance" | "salary_loan" | "sss" | "pagibig" | "other";
...
export interface DeductionOverride {
  id?: string;                      // PK — generated by DB if not supplied
  employeeId: string;
...
export type DeviceIntegrityResult = "pass" | "fail" | "mock";
...
export interface AttendanceEvidence {
  ...
  qrTokenId?: string;
  deviceIntegrityResult?: DeviceIntegrityResult;
...
/** @deprecated Use QRToken instead — kept for backward compatibility */
...
// ─── Appearance Config (maps to appearance_config table) ───────────────
