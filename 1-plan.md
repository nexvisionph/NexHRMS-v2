...
- On the payroll run, after the run completes, on the onhold modal, ther should be a batch action reissue all that has the same functionality as the record payment stage reissue all batch action.

## Question

- Those who got removed on the payslip checklist, how can we reissue their paslip again?