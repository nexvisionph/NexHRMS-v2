<%@ page language="C#" autoeventwireup="true" inherits="RTEnrollView, App_Web_lofxcc4m" enableEventValidation="false" %>
    ...
    &nbsp;&nbsp; FKAttend BS Sample <asp:Label ID="Version" runat="server"></asp:Label></div>
        ...
        <asp:Panel ID="Panel2" runat="server" style="margin-top: 13px">
            ...
            >
                ...
                <Columns>
                    <asp:BoundField DataField="regtime" HeaderText="Update Time" ReadOnly="True"  
