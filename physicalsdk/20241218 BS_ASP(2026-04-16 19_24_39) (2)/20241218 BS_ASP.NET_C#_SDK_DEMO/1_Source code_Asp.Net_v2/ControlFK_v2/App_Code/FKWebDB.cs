...
namespace FKWeb
{
    public class FKWebDB
    {
            ...
            string asDevInfo)
        {
            ...
            FKWebTools.PrintDebug(csFuncName, "0 - DevId:" + asDevId + ", DevName:" + asDevName + ", DevInfo:" + asDevInfo);
        ...
        public void GetBarcode(string asDevId, out string sBarcode)
        {
            ...
            //sBarcode = BitConverter.ToString(abytEnroll);
            sBarcode = System.Text.Encoding.UTF8.GetString(abytEnroll);
